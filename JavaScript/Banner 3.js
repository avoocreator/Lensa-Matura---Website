...
const RUNDOWN_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ6wT6xGSgaGcWRT-bQxu5P_0SfDq9RppWKqMByMfJ8CHFugHJ4vnhyuYk_A6wio0GXYv5b4kRHLf0Z/pub?gid=1414365329&single=true&output=csv";

// URL Mekanisme Event
const MEKANISME_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ6wT6xGSgaGcWRT-bQxu5P_0SfDq9RppWKqMByMfJ8CHFugHJ4vnhyuYk_A6wio0GXYv5b4kRHLf0Z/pub?gid=2134236627&single=true&output=csv";


// Mengubah CSV menjadi Array Objek
...
const eventDate = new Date("2025-05-02 08:00:00").getTime();
...
function updateCountdown() {
    ...
    // --- 2. ACARA SEDANG BERLANGSUNG (Sudah dimulai, tapi belum lewat 5 hari) ---
    if (diff <= 0) {
