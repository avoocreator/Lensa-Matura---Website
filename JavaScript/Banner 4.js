// ==========================================================
// KONFIGURASI DATA SPREADSHEET (SILAKAN GANTI URL INI!)
// ==========================================================

// URL Rundown Kegiatan (dari Tab "Rundown Kegiatan" yang sudah di-Publish)
const RUNDOWN_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ6wT6xGSgaGcWRT-bQxu5P_0SfDq9RppWKqMByMfJ8CHFugHJ4vnhyuYk_A6wio0GXYv5b4kRHLf0Z/pub?gid=564751099&single=true&output=csv"; 

// URL Mekanisme Event (dari Tab "Mekanisme Event" yang sudah di-Publish)
const MEKANISME_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ6wT6xGSgaGcWRT-bQxu5P_0SfDq9RppWKqMByMfJ8CHFugHJ4vnhyuYk_A6wio0GXYv5b4kRHLf0Z/pub?gid=1804489865&single=true&output=csv";


// ==========================================================
// FUNGSI UTILITY: Mengubah CSV menjadi Array Objek
// ==========================================================
...
// COUNTDOWN LOGIC
// ==========================================================
const eventDate = new Date("2025-11-10 08:00:00").getTime();
...
function revealElements() {
    ...
    for (let i = 0; i < reveals.length; i++) {
        ...
        // TAMBAHAN: Jika elemen keluar dari area pandang (ke bawah layar)
        else {
...
const mekanismePopup = document.getElementById("mekanismePopup"); // Ambil ulang variabel ini
...
// ... (Bagian COUNTDOWN LOGIC) ...

// ... (Bagian FITUR BAGIKAN (SHARE)) ...

// ... (Bagian ANIMASI SCROLL REVEAL - TETAPKAN YANG LAMA JIKA SUDAH ADA, JIKA TIDAK, GANTI DENGAN INI) ...
function revealElements() {
    let reveals = document.querySelectorAll(".reveal");
...
// ... (Bagian NAVIGASI TOGGLE (HAMBURGER)) ...

// ... (Bagian POPUP MEKANISME) ...
